...
using Quick_Application2.ViewModels;
using Quick_Application2.Helpers;
using Quick_Application2.Authorization;
...
namespace Quick_Application2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("Quick_Application2"));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.SwaggerDoc("v1", new Info { Title = "Quick_Application2 API", Version = "v1" });
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Quick_Application2 API V1");
            });
